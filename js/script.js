/* ============================================================
   ...
   document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.navbar-nav .nav-link').forEach(link => {
      link.classList.remove('active'); // clear any hardcoded active in HTML
    ...
    if (lightbox) {
      // Collect all lightbox images and attach click to the whole .gallery-item wrapper
      ...
      lightbox.querySelector('.lightbox-arrow.next')?.addEventListener('click', () => openLb((lbCurrent + 1) % lbItems.length));
      lightbox.querySelector('.lightbox-arrow.prev')?.addEventListener('click', () => openLb((lbCurrent - 1 + lbItems.length) % lbItems.length));
